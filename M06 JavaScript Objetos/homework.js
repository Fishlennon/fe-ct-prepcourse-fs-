...
function crearGato(nombre, edad) {
   ...
   // Retornar el objeto.
   // Tu código:
   let gatos={nombre:nombre,edad:edad}
  
   gatos.meow=function(){return("Meow!")}
   return (gatos)
   /*let gatos={nombre:nombre,edad:edad,meow:function(){return("Meow!")}} 
      return(gatos)*/
}
...
function tieneEmail(objetoUsuario) {
   ...
   // Tu código:
   /*let tieneemaile = objetoUsuario.hasOwnProperty("email")
   return(tieneemaile)*/
...
function agregarAmigo(objetoUsuario, nuevoAmigo) {
   ...
   return(objetoUsuario)*///esto solo reemplaza la propiedad original "amigos" con uno nuevo y el nuevoamigo
}
